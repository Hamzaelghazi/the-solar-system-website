...
class WPSB_Woo {
    ...
    private function __construct() {
        ...
        // NOTE: the plugin no longer adds its own "Buy Now" button — the theme's
        // native Add to Cart / Buy Now are used as-is, and checkout hands off to
        // Shopify via the "Pay via Shopify" gateway at Place Order.
    }
